...
export const MAP_MARKERS = [
  ...
  { id: "G", label: "G", lat: 23.489, lng: 85.474, zoom: 12, stage: "Retailer", name: "Kishor Exports · Global Distribution", address: "Plot No. E,F,G Kulhi Industrial Area Ormanjhi, Ranchi-835219 (Jharkhand), India", color: "#0f1b3d" },
];